...
var body = $response.body.replace(/"buyButtonStatus":"1"/g, '"buyButtonStatus":"0"').replace(/"isFilter":"0"/g, '"isFilter":"1"').replace(/"isFinish":"0"/g, '"isFinish":"1"');
 }

if (url.indexOf(path3) != -1) {
var body = $response.body.replace(/"courseStatus":"lock"/g, '"courseStatus":""');
 }

if (url.indexOf(path4) != -1) {
var body = $response.body.replace(/"isLock":"1"/g, '"isLock":"0"').replace(/"isTry":"0"/g, '"isTry":"1"');
 }
...
var body = $response.body.replace(/"title":"未开通会员"/g, '"title":"已开通会员"').replace(/"type":"not_yet"/g, '"type":"10"');
 }
$done({body});